...
const ChatBox = () =>{
    ...
    return (<Stack gap={4} className="chat-box">
        ...
        <Stack gap={3} className="messages">
            ...
            (<Stack key={index} className={`${message?.senderId === user?.id ? "message self align-self-end flex-grow-0" 
        ...
        <Stack direction="horizontal" gap={3} className="chat-input flex-grow-0">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-send-fill" viewBox="0 0 16 16">
                    <path d="M15.964.686a.5.5 0 0 0-.65-.65L.767 5.855H.766l-.452.18a.5.5 0 0 0-.082.887l.41.26.001.002 4.995
                     3.178 3.178 4.995.002.002.26.41a.5.5 0 0 0 .886-.083l6-15Zm-1.833 1.89L6.637 10.07l-.215-.338a.5.5 0 0 
